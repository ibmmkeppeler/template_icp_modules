...
route add -net 0.0.0.0 netmask 0.0.0.0 gw 10.135.29.9 dev ens160
route add -net 10.0.0.0 netmask 255.0.0.0 gw 10.135.29.1 dev ens160
route del -net 0.0.0.0 gw 10.135.29.1 netmask 0.0.0.0 dev ens160
# sudo ifdown ens160
# sudo ifup ens160
